                        ...
                        /////// UPDATE feech_info table ///////
                          if ($admin == 1 || $admin == 7) {
                            ...
                            if (mysqli_num_rows($result) > 0) {
                              ...
                              added_by='$added_by_old - $user',
                              `add_date` = current_timestamp()            
                              wherejeha = '$inserted_jeha' AND ketab_num = $inserted_ketab_num AND ketab_date='$inserted_ketab_date' AND details_type='$details_type' ORDER BY ketab_num ASC " ;
