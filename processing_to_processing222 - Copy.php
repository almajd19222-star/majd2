...
<?php
 ...
 if ($jeha_profile=='الإدارة المركزية للمعلومات' && $inserted_jeha == 'الإدارة المركزية للمعلومات') {
  ...
  if(!empty($_GET['id']) && !empty($_GET['type']) && $_GET['type']=='archive' ) {
      ...
      if(mysqli_num_rows($check_sader_result) > 0){ //if there is result in processing_to_processing table go inside if statement
        ...
        /////// UPDATE reports_info table ///////
          ...
          while($report_row = mysqli_fetch_assoc($sql_reports_result)) {   
            ...
            if (mysqli_num_rows($check_sader_result) > 0) { // if there is previous ketab_num and ketab_date in processing_to_processing
...
$table_name[]='mawkoof_120';
            ...
            }else{ // if there is NOT previous ketab_num and ketab_date in processing_to_processing
...
$table_name[]='mawkoof_120';
        ...
        if(mysqli_query($conn, $sql1)){
          ...
          while($report_row = mysqli_fetch_assoc($sql_reports_result)) {   
            ...
            if (mysqli_num_rows($check_sader_result) > 0) { //check if there is inserted ketab_num and ketab_date in processing_to_processing table
              $ketab_num_sader = $check_sader_row['ketab_num_sader'];
              $ketab_date_sader = $check_sader_row['ketab_date_sader'];
...
$table_name[]='mawkoof_120';
              ...
              if (mysqli_query($conn, $update_reports_info)) {
                    ...
                    $sql="INSERT INTO `processing_to_processing` (ketab_num_pre, ketab_date_pre, ketab_num_sader, ketab_date_sader, edbara_num_pre, edbara_date_pre, edbara_num_sader, edbara_date_sader, jeha, details_type)
...
$table_name[]='mawkoof_120';
            ...
            //// 2022 ////
              ...
              $sql77="INSERT INTO processing_to_processing (ketab_num_pre, ketab_date_pre, ketab_num_sader, ketab_date_sader, jeha, details_type)
