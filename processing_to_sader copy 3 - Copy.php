            ...
            if (mysqli_num_rows($check_sader_result) > 0) { // if there is previous ketab_num and ketab_date in processing_to_sader
              ...
              if(mysqli_query($conn, $update_reports_info)){             
                ...
                /////// UPDATE study table ///////              
                  ...
                  $sql="SELECT `id` FROM `study` WHERE ketab_num=$inserted_ketab_num AND ketab_date='$inserted_ketab_date' AND jeha='$inserted_jeha' AND details_type='$details_type'";
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    where ketab_num=$inserted_ketab_num AND ketab_date='$inserted_ketab_date' AND jeha='$inserted_jeha' AND details_type='$details_type' ORDER BY ketab_num ASC" ;
                ...
                /////// UPDATE feech_info table ///////
                  if($admin == 1 || $admin == 7){
                    ...
                    $sql="SELECT `id` FROM `feech_info` WHERE ketab_num=$inserted_ketab_num AND ketab_date='$inserted_ketab_date' AND jeha='$inserted_jeha' AND details_type='$details_type'";
                    $result = mysqli_query($conn,$sql);        
                    if (mysqli_num_rows($result) > 0) {
              ...
              if(mysqli_query($conn, $update_reports_info)){
                ...
                /////// UPDATE study table ///////               
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    added_by='$added_by_old - $user',
                    add_date = current_timestamp()
                    where jeha='$inserted_jeha' AND details_type='$details_type' AND  ketab_num=$inserted_ketab_num AND ketab_date='$inserted_ketab_date'  ORDER BY ketab_num ASC" ;
...
$table_name[]='mawkoof_120';
              ...
              SELECT $report_r_num_max, '$today', $report_r_num_max, '$today', `sendfrom`, `r_title`, `r_following_date`, `sendto`, `send_date`, '$user', current_timestamp(), '$jeha_profile', '$details_type_new', `resala_type`, `jeha`, `isPrivate`, `isReport`,`id_num` FROM reports_info WHERE id=$id_report";
              ...
              if(mysqli_query($conn, $update_reports_info)){             
                ...
                /////// UPDATE study table ///////
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        added_by='$added_by_old - $user',
                        add_date = current_timestamp()
                        where jeha = '$inserted_jeha' AND ketab_num = $inserted_ketab_num AND ketab_date='$inserted_ketab_date' AND details_type='$details_type' ORDER BY ketab_num ASC" ;
  ...
  if(!empty($_GET['id']) && !empty($_GET['type']) && $_GET['type']=='k_pub' ) {
    ...
    $inserted_ketab_date = $sql_row['ketab_date'];
      ...
      $sql2 = "UPDATE `reports_info` SET
        ...
        $sql9 = "INSERT INTO `dewan` (".$dewan_cols.")  SELECT 0, 0, `e_year`, $r_num_max, '$today', $r_num_max, '$today', `sendfrom`, `r_title`, `r_following_date`, '',`sendto`, `send_date`, '$user', current_timestamp(), '$jeha_profile', 1, '', '', '', '$details_type_new', `resala_type`, `jeha`, 0,'0000-00-00', 0,'0000-00-00', isPrivate, `isReport`,`id_num` FROM `reports_info` WHERE  id=$id";
