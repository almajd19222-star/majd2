...
<?php
/* id='.$row['3'].'&edbara_num='.$row['9'].'&edbara_date='.$row['10'].'&e_id=&jeha='.$row['0'].'&details_type='.$row['1'].'&resala_type=كتاب&e_year='.date('Y',strtotime($row['10'])).'&added_by_old='.$row['27'].'&type=archive */

if ($_SERVER['REQUEST_METHOD'] == 'POST') {

@$inserted_edbara_num = $_POST['edbara_num'];
@$inserted_edbara_date = $_POST['edbara_date'];
@$inserted_jeha = $_POST['jeha'];
@$details_type = 'قيد المعالجة';
$details_type_new = 'صادر';


$sql = "select id,added_by FROM details where edbara_num=$inserted_edbara_num AND edbara_date ='$inserted_edbara_date' AND jeha='$inserted_jeha'";
...
if(!empty($_POST['ketab_num_min'])){
  $num_start = mysqli_real_escape_string($conn, $_POST['ketab_num_min']);
}else{
  $num_start = 0;
}

if(!empty($_POST['ketab_num_max'])){
  $num_end = mysqli_real_escape_string($conn, $_POST['ketab_num_max']);
}else{
  $num_end = 0;
}
...
if(!empty($num_start) && $num_start != 0 && !empty($ketab_year)){ 
  ...
  /////////////////////////////////////////////////
    ...
    if (mysqli_num_rows($check_sader_result) > 0) { //if there is result in processing_to_sader table go inside if statement
      ...
      $sql_reports = "SELECT id,ketab_num,ketab_date FROM `reports_info` WHERE jeha='$inserted_jeha' AND details_type='$details_type' AND edbara_num=$inserted_edbara_num AND edbara_date='$inserted_edbara_date'  ORDER BY ketab_num ASC";
      ...
      while ($report_row = mysqli_fetch_assoc($sql_reports_result)) {
        ...
        if (mysqli_num_rows($check_sader_result) > 0) { // if there is previous ketab_num and ketab_date in processing_to_sader
          ...
          if (mysqli_query($conn, $update_reports_info)) {
            ...
            $sql6 = "UPDATE reports_info SET
                sader=1 WHERE jeha='$inserted_jeha' AND details_type='$details_type' AND  ketab_num=$inserted_ketab_num AND ketab_date='$inserted_ketab_date'  ORDER BY ketab_num ASC";
            ...
            $sql = "SELECT `id` FROM `study` WHERE edbara_num=$inserted_edbara_num AND edbara_date='$inserted_edbara_date' AND jeha='$inserted_jeha' AND details_type='$details_type'";
            ...
            if (mysqli_num_rows($result) > 0) {
              ...
              $update_study = "UPDATE `study` SET
                    ...
                    where edbara_num=$inserted_edbara_num AND edbara_date='$inserted_edbara_date' AND jeha='$inserted_jeha' AND details_type='$details_type' ORDER BY ketab_num ASC";

              if (mysqli_query($conn, $update_study)) {

                $update_study_sader = "UPDATE `study` SET
                      sader=1 WHERE jeha='$inserted_jeha' AND details_type='$details_type' AND  edbara_num=$inserted_edbara_num AND edbara_date='$inserted_edbara_date'  ORDER BY ketab_num ASC";
                ...
                if (mysqli_query($conn, $update_tbl_uploads)) {
                  ...
                  echo "Error sql_uploads study check_sader_result: " . "<br>" . mysqli_error($conn);
                  exit;
                }
              } else {
                echo "Error Study check_sader_result: " . "<br>" . mysqli_error($conn);
                exit;
              }
            }
            ...
            if ($admin == 1 || $admin == 7) {
              ...
              $sql = "SELECT `id` FROM `feech_info` WHERE edbara_num=$inserted_edbara_num AND edbara_date='$inserted_edbara_date' AND jeha='$inserted_jeha' AND details_type='$details_type'";
              $result = mysqli_query($conn, $sql);
              if (mysqli_num_rows($result) > 0) {
                ...
                if (mysqli_query($conn, $update_feech_info)) {
                  ...
                  if (mysqli_query($conn, $update_tbl_uploads)) {
                    ...
                    echo "Error sql_uploads feech check_sader_result : " . "<br>" . mysqli_error($conn);
                    exit;
                  }
                } else {
                  echo "Error feech_info check_sader_result: " . "<br>" . mysqli_error($conn);
                  exit;
                }
              }
            }
            ...
            echo "Error update_reports_info: " . "<br>" . mysqli_error($conn);
            exit;
          }
        } else { // if there is NOT previous ketab_num and ketab_date in processing_to_sader
          ...
          if (mysqli_query($conn, $update_reports_info)) {
            ...
            if (mysqli_num_rows($result) > 0) {
              ...
              $update_study = "UPDATE `study` SET
                    ...
                    `sendfrom`='$jeha_profile',
                    `add_date` = current_timestamp()
                    where jeha='$inserted_jeha' AND details_type='$details_type' AND  edbara_num=$inserted_edbara_num AND edbara_date='$inserted_edbara_date'  ORDER BY ketab_num ASC";
              ...
              if (mysqli_query($conn, $update_study)) {
                ...
                if (mysqli_query($conn, $update_tbl_uploads)) {
                  ...
                  echo "Error sql_uploads study: " . "<br>" . mysqli_error($conn);
                  exit;
                }
              } else {
            ...
            echo "Error sql_reports NOT IN check_sader_result: " . "<br>" . mysqli_error($conn);
            exit;
          }


          $dewan_insert = "INSERT INTO `dewan` (`dewan_num`, `dewan_date`, `ketab_num`, `ketab_date`, `sendfrom`, `brief`, `following_date`, `sendto`, `sendto_date`, `added_by`, `add_date`, `jeha`, `details_type`, `resala_type`, `origin_sendfrom`, `isPrivate`, `isReport`,`id_num`) 
              SELECT $report_r_num_max, '$today', $report_r_num_max, '$today', '$jeha_profile', `r_title`, `r_following_date`, `sendto`, `send_date`, '$user', current_timestamp(), '$jeha_profile', '$details_type_new', `resala_type`, `jeha`, `isPrivate`, `isReport`,`id_num` FROM reports_info WHERE id=$id_report";
      ...
      $sql1 = "INSERT INTO `details` (" . $details_cols . ")  SELECT nick_name, name, fname, lname, mname, pbirth, dbirth, address, sex, national, awsaf, jeha_name, 0, $year, $edbara_num_max, '$today', 0, '0000-00-00',  study, edbara_note, edbara_info, note, result, details_attach, details_attach_extension, foto1, foto2, foto3, data_type, '$jeha_profile', '$user', current_timestamp(), '$details_type_new', resala_type, 1, 0 , `jeha`, `id_num`, isPrivate FROM details  where id = $id";

      if (mysqli_query($conn, $sql1)) {

        $sql_dup = "INSERT INTO `dup_names_check` (`fullname`, `name`, `fname`, `lname`, `mname`, `dbirth`, `pbirth`, `jeha`,   `details_type`, `e_id`, `edbara_num`, `edbara_date`) SELECT `fullname`, `name`, `fname`, `lname`, `mname`, `dbirth`,  `pbirth`, '$jeha_profile', '$details_type_new', 0, $edbara_num_max, '$today' FROM `dup_names_check` WHERE    jeha='$inserted_jeha' AND details_type='$details_type' AND edbara_num=$inserted_edbara_num ";
        ...
        while ($report_row = mysqli_fetch_assoc($sql_reports_result)) {
          ...
          if (mysqli_num_rows($check_sader_result) > 0) { //check if there is inserted ketab_num and ketab_date in processing_to_sader table
            $ketab_num_sader = $check_sader_row['ketab_num_sader'];
            $ketab_date_sader = $check_sader_row['ketab_date_sader'];
            ...
            if (mysqli_query($conn, $update_reports_info)) {
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                $update_study = "UPDATE `study` SET
                        ...
                        `sendfrom`='$jeha_profile',
                        `add_date` = current_timestamp()
                        where jeha = '$inserted_jeha' AND edbara_num=$inserted_edbara_num AND edbara_date='$inserted_edbara_date' AND details_type='$details_type' ORDER BY ketab_num ASC";
          ...
          } else { // if check_sader_result for ketab_num and ketab_date is NOT TRUE
            ...
            if (mysqli_query($conn, $update_reports_info)) {
              ...
              $sql = "INSERT INTO `processing_to_sader` (ketab_num_pre, ketab_date_pre, ketab_num_sader, ketab_date_sader, edbara_num_pre, edbara_date_pre, edbara_num_sader, edbara_date_sader, jeha, details_type)
              ...
              if (mysqli_query($conn, $update_tbl_uploads)) {
                ...
                echo "Error sql_uploads  new: " . "<br>" . mysqli_error($conn);
                exit;
              }
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                if (mysqli_query($conn, $update_study)) {
                  ...
                  if (mysqli_query($conn, $update_tbl_uploads)) {
                    ...
                    echo "Error sql_uploads study new: " . "<br>" . mysqli_error($conn);
                    exit;
                  }
                } else {
                  echo "Error Study new: " . "<br>" . mysqli_error($conn);
                  exit;
                }
              }
                ...
                if (mysqli_num_rows($result) > 0) {
                  ...
                  if (mysqli_query($conn, $update_feech_info)) {
                    ...
                    if (mysqli_query($conn, $update_tbl_uploads)) {
                      ...
                      echo "Error sql_uploads feech new: " . "<br>" . mysqli_error($conn);
                      exit;
                    }
                  } else {
                    echo "Error feech_info new: " . "<br>" . mysqli_error($conn);
                    exit;
                  }
                }
              }
              ...
              if ($number >= 1) {
                ...
                if (mysqli_query($conn, $update_tbl_uploads)) {
                  ...
                  echo "Error sql_uploads mawkoof new: " . "<br>" . mysqli_error($conn);
                  exit;
                }
              }
              ...
              if ($number >= 1) {
                for ($i = 0; $i < $number; $i++) {
                  ...
                  if (mysqli_num_rows($result_check) > 0) {
                    ...
                    if (mysqli_query($conn, $sql)) {
                      ...
                      echo "Error:  " . $sql_table_name . " new<br>" . mysqli_error($conn);
                      exit;
                    }
                  }
                }
                ...
                if (mysqli_query($conn, $update_tbl_uploads)) {
                  ...
                  echo "Error sql_uploads studies new: " . "<br>" . mysqli_error($conn);
                  exit;
                }
              }
              ...
              echo "Error sql_reports new: " . "<br>" . mysqli_error($conn);
              exit;
            }
...
////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////
if(!empty($_POST['ketab_nums'])){
  $ketab_nums = mysqli_real_escape_string($conn, $_POST['ketab_nums']);
}else{
  $ketab_nums=0;
}

if(!empty($ketab_nums) && $ketab_nums != 0 && !empty($ketab_year)){ 
       
          
    // Extract all numbers from the input
    preg_match_all('/\d+/', $ketab_nums, $matches);

    // Assign numbers to an array
    $numbers = $matches[0];
    $ketab_nums= implode(',',$numbers);
