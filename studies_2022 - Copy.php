...
if (isset($_POST['submit'])) {
    ...
    if ($_GET['edit'] == '0') {
        ...
        header("Location: studies_2022.php?details_type=".$details_type."&type_code=".$type_code."&edit=0");
    }
}
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <form id="myform" name="myform"  action="studies_2022.php?details_type=<?php echo $details_type; ?>&type_code=0&edit=0" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
